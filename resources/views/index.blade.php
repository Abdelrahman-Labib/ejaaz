...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-7 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Learn new things easily <br> With Ejaaz</h2>
              <p>Ejaaz is an online learning platform featuring a lot of videos courses taught by expert instructors. Take courses in anything from programming to personal development classes like design, Languages, Management and Health. Join us and explore new hobbies on Ejaaz.</p>
              <div class="header-button">
                <a href="https://play.google.com/store/apps/details?id=com.ejaazapp" target="_blank" class="btn btn-common btn-effect"><i class="lni-android"></i> From PlayStore<br></a>
                <a href="#" target="_blank" class="btn btn-border"><i class="lni-apple"></i> From AppStore<br></a>
              </div>
            </div>
          </div>
          <div class="col-lg-5 col-md-12 col-xs-12">
            <div class="intro-img">
              <img src="/Logo sample two.png" alt="">
            </div>            
          </div>
        </div> 
      </div>             
          ...
          <div class="col-lg-4 col-md-12 col-xs-12">
            <div class="content-left text-right">
              <div class="box-item left">
                ...
                <div class="text">
                  <h4>User Friendly</h4>
                  <p>Application, process, or system that is compatible with its intended user's ability to use it easily and successfully.</p>
                </div>
              </div>
              <div class="box-item left">
                <span class="icon">
                ...
                <div class="text">
                  ...
                  <p>Super-fast and flexible system.</p>
                </div>
              </div>
              <div class="box-item left">
                <span class="icon">
                ...
                <div class="text">
                  <h4>24/7 Support</h4>
                  <p>means a support service that is provided 24 hours a day and 7 days a week.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-12 col-xs-12">
            <div class="content-right text-left">
              <div class="box-item right">
                ...
                <div class="text">
                  <h4>Secure</h4>
                  <p>Security and protection system, any of various means  designed to protect you.</p>
                </div>
              </div>
              <div class="box-item right">
                <span class="icon">
                ...
                <div class="text">
                  ...
                  <p>Now you can learn with ease from home.</p>
                </div>
              </div>
              <div class="box-item right">
                <span class="icon">
                ...
                <div class="text">
                  <h4>Indoor Courses</h4>
                  <p>Don't like e-learning! We have covered your back.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="text-wrapper wow fadeInRight" data-wow-delay="0.6s">
              <div>
                ...
                <p>Just signup and login to your account to access millions of features.</p>
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="text-wrapper wow fadeInRight" data-wow-delay="0.9s">
              <div>
                ...
                <h3>Free Courses!</h3>
                <p>Thousands of free courses are waiting for you.</p>
                <!--<a class="btn btn-rm" href="#">Read More <i class="lni-arrow-right"></i></a>-->
              </div>
            </div>
          </div>
    ...
    <!--            <img class="img-fluid" src="img/screenshot/img-0.png" alt="">-->
    <!--          </div>-->
    <!--        </div  -->
    <!--        <div class="item">-->
    <!--          <div class="screenshot-thumb">-->
    ...
    <!--        <div class="item">-->
    <!--          <div class="screenshot-thumb">-->
    <!--            <img class="img-fluid" src="img/screenshot/img-7.png" alt="">-->
    <!--          </div>-->
    <!--        </div>-->
    <!--      </div>-->
    <!--    </div>-->
    ...
    <!--              <p>Appropriately implement one-to-one catalysts for change vis-a-vis wireless catalysts for change. Enthusiastically architect adaptive.</p>-->
    <!--            </div>-->
    <!--            <a href="https://play.google.com/store/apps/details?id=com.ejaazapp" class="btn btn-common btn-effect"><i class="lni-android"></i> From PlayStore<br></a>-->
                ...
                <div class="contact-block wow fadeInUp" data-wow-delay="0.2s">
                  <div class="section-header">   
                    ...
                    <h2 class="section-title">Love to Hear From You</h2>
                          ...
                          <h6>Name </h6>
                          <p class="btn btn-subtitle wow fadeInDown">Yahya</p>
                      
                      
                          <h6>Email </h6>
                          <p class="btn btn-subtitle wow fadeInDown">karim.elbadry2@gmail.com</p>
    ...
    <footer>
      ...
      <!--<section class="footer-Content">-->
        ...
        <!--</div>-->
        <!-- Copyright Start  -->
        <div class="copyright" style="background-image:-webkit-linear-gradient(0deg, #3c96ff 0%, #2dfbff 100%);">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <div class="site-info float-left">
                  <p>&copy; 2020 - Designed by <a href="http://ejaaztech.com" rel="nofollow">Ejaaz</a></p>
                </div>              
